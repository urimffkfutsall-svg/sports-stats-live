      ...
      >
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative z-20 flex items-center justify-between px-5 pt-4">
            ...
            <button onClick={onClose} className="w-9 h-9 rounded-xl bg-white border border-gray-200 flex items-center justify-center hover:bg-gray-50 hover:border-[#1E6FF2]/30 transition-all text-gray-400 hover:text-gray-600 text-sm font-bold shadow-sm">
              \\u2715
            </button>
          </div>
...
console.log("[OK] MatchDetailModal.tsx — gray surface + blue border premium design");
