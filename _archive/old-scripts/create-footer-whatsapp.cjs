...
// =====================================================
// 1) REWRITE FOOTER - simple with logo center + contact
// =====================================================
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <div className="flex flex-col items-center gap-2 mt-2">
            ...
            {settings.contact && (
              <a href={"tel:" + settings.contact.replace(/[^0-9+]/g, '')} className="text-[#d0a650] text-lg font-bold hover:text-white transition-colors">
                {settings.contact}
              </a>
            )}
          </div>
...
fs.writeFileSync("src/components/Footer.tsx", newFooter, "utf8");
console.log("[OK] Footer rewritten - logo center + contact");

// =====================================================
// 2) CREATE WhatsApp Floating Button Component
// =====================================================
const whatsapp = `import React, { useState, useEffect } from 'react';

const WHATSAPP_NUMBER = '38344123456'; // Ndrysho numrin ketu
...
fs.writeFileSync("src/components/WhatsAppButton.tsx", whatsapp, "utf8");
console.log("[OK] WhatsAppButton component created");

// =====================================================
// 3) ADD WhatsAppButton to App.tsx (global, all pages)
// =====================================================
...
if (!app.includes("WhatsAppButton")) {
  ...
  // Add before closing </BrowserRouter>
  app = app.replace(
    '</BrowserRouter>',
    '  <WhatsAppButton />\n              </BrowserRouter>'
  );
  fs.writeFileSync("src/App.tsx", app, "utf8");
  console.log("[OK] WhatsAppButton added to App.tsx (all pages)");
} else {
  console.log("[SKIP] WhatsAppButton already in App.tsx");
}

console.log("\n[DONE] Footer + WhatsApp ready!");
console.log("IMPORTANT: Edit src/components/WhatsAppButton.tsx line 3 to set correct phone number!");
