    ...
    <div className="min-h-screen bg-[#F1F5F9] flex flex-col">
      ...
      <div className="flex-1 max-w-6xl mx-auto w-full px-4 py-8">
        <div className="flex items-center gap-3 mb-8">
          <div className="w-12 h-12 bg-gradient-to-br from-[#0f1830] to-[#0f1830] rounded-xl flex items-center justify-center shadow-lg">
        ...
        <div className="flex gap-3 mb-6">
          <button onClick={function() { setTab('superliga'); }} className={'px-5 py-2.5 rounded-xl text-sm font-medium transition-all ' + (tab === 'superliga' ? 'bg-[#0f1830] text-white shadow-lg shadow-[#0f1830]/25' : 'bg-white text-gray-600 border border-gray-200 hover:bg-gray-50')}>
            Superliga
          </button>
          <button onClick={function() { setTab('liga_pare'); }} className={'px-5 py-2.5 rounded-xl text-sm font-medium transition-all ' + (tab === 'liga_pare' ? 'bg-[#0f1830] text-white shadow-lg shadow-[#0f1830]/25' : 'bg-white text-gray-600 border border-gray-200 hover:bg-gray-50')}>
            Liga e Pare
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {displayTeams.length === 0 ? (
            ...
            return (
              <div key={t.id} onClick={function() { navigate('/skuadra/' + t.id); }} className="bg-white border border-gray-200 rounded-2xl p-6 text-center hover:shadow-xl hover:border-[#0f1830]/30 transition-all cursor-pointer group">
