      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {streams.length === 0 ? (
          <div className="text-center py-20">
            ...
            <Link to="/live" className="inline-block mt-6 px-6 py-2.5 bg-[#0f1830] text-white rounded-xl font-bold text-sm hover:bg-[#1858C8]">Shiko ndeshjet</Link>
          </div>
        ) : (
              ...
              <div className="space-y-3">
                {streams.map(s => (
                  <button
                    ...
                    className={"w-full text-left rounded-xl border p-3 transition-all " + (selectedStream?.id === s.id ? "bg-[#0f1830]/10 border-[#0f1830]/40" : "bg-gray-900/50 border-gray-800 hover:border-gray-700")}
                  >
