                ...
                <div key={v.id} onClick={() => setActiveVideo(v)} className="bg-white rounded-xl border border-gray-100 overflow-hidden cursor-pointer hover:shadow-lg transition-all duration-200 group">
                  <div className="relative aspect-video bg-gray-900">
                    {thumb ? (
                      ...
                      <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-[#0f1830] via-[#0F2D5E] to-[#0f1830] p-4">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity">
                      <div className="w-14 h-14 rounded-full bg-white/90 flex items-center justify-center shadow-lg">
                        <span className="text-[#0f1830] text-2xl ml-1">â–¶</span>
                      </div>
                    </div>
                  </div>
                  <div className="p-3">
