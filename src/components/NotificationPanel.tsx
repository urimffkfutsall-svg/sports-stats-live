...
import { onNotification, getNotificationChannel } from '@/lib/api-db';
...
const NotificationPanel: React.FC = () => {
  ...
  useEffect(() => {
    if (channelInitialized.current) return null;
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-gray-50">
            ...
            <div className="flex items-center gap-1">
              ...
              {notifications.length > 0 && (
                <>
                  <button onClick={markAllRead} className="p-1.5 text-gray-400 hover:text-[#1E6FF2] hover:bg-gray-100 rounded-lg" title="Lexo tÃ« gjitha">
